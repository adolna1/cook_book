 ...
 */
final class Version20200418193048 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipes ADD created_at DATETIME NOT NULL, CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipes DROP created_at, CHANGE category_id category_id INT DEFAULT NULL');
