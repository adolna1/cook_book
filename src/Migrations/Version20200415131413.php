 ...
 */
final class Version20200415131413 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipy_ingradients_ingradients (recipy_ingradients_id INT NOT NULL, ingradients_id INT NOT NULL, INDEX IDX_D5CCF74DA07EDB4 (ingradients_id), INDEX IDX_D5CCF74D39959271 (recipy_ingradients_id), PRIMARY KEY(recipy_ingradients_id, ingradients_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
